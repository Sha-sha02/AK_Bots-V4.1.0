...
await ryozingod.updateProfileStatus(`✳️ Şèđ ŠªŢąÑ+ || ✅ Runtime : ${uptime}`)
...
sourceUrl: `https://youtube.com/@b4udrogan`,
mediaUrl: `https://youtube.com/@b4udrogan`
}
},
text: teks
}, {
...
let itsmenu = `
┏❐  ⌜ Şèđ ŠªŢąÑ Bot ⌟  ❐
┃⭔ Creator : By Şèđ ŠªŢąÑ+
┃⭔ patner : 𝗄𝖿𝗅𝗂,𝗃𝗈𝗌𝖾,𝖾𝗉𝖺𝗇,𝗐𝗂𝗅𝖽𝖺𝗇
┃⭔ Type : Case
┃⭔ Status : Ready
...
//=================================================//
case 'sc': case 'script': {
joreply(`🌤️Sc Ini Dibuat Oleh By Şèđ ŠªŢąÑ+.
...
"contactMessage": {
"displayName": `${namaown}`,
"vcard": `BEGIN:VCARD\nVERSION:3.0\nN:;;;;\nFN:${namaown}\nitem1.TEL;waid=${global.ownMain}:+${global.ownMain}\nitem1.X-ABLabel:Ponsel\nX-WA-BIZ-DESCRIPTION:[[ ༑ Şèđ ŠªŢąÑ ⿻ 𝐏𝐔𝐁𝐋𝐢𝐂 ༑ ]]\nX-WA-BIZ-NAME: [[ ༑ Şèđ ŠªŢąÑ ⿻ 𝐏𝐔𝐁𝐋𝐢𝐂 ༑ ]]\nEND:VCARD`,
}
...
if (!text) return joreply(`*Example: ${prefix+command} https://youtube.com/@b4udrogan*`)
